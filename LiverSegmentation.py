# -*- coding: utf-8 -*-
"""
# Liver 3D segmentation with MONAI
...
data_dir = os.path.join(root_dir, "Liver_Data")
out_dir = os.path.join(root_dir, "Liver_Best_Model")
...
train_inf_loader = DataLoader(train_inf_ds, batch_size=2, num_workers=0)
...
out_dir = "//home//imoreira//Data//Liver_Best_Model"
#out_dir = "C:\\Users\\isasi\\Downloads\\Liver_Best_Model"
