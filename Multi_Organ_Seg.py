...
train_loader = DataLoader(train_ds, batch_size=0, shuffle=True, num_workers=0)


train_inf_ds = CacheDataset(data=train_files, transform=train_inf_transforms, cache_rate=1.0, num_workers=0)
train_inf_loader = DataLoader(train_inf_ds, batch_size=0, num_workers=0)

val_ds = CacheDataset(data=val_files, transform=val_transforms, cache_rate=1.0, num_workers=0)
# val_ds = Dataset(data=val_files, transform=val_transforms)
val_loader = DataLoader(val_ds, batch_size=0, num_workers=0)
...
test_loader = DataLoader(test_ds, batch_size=0, num_workers=0)
